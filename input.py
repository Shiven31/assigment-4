...
#creating object
student1 = Student("Shiven", 21104017)
...
#question 6
print("Question6")
#input first word(george turn)
word = input("Enter the first word: ")

#input a meaningful word with the exact same letters(barbie turn)
...
# verify the letters of the new word
